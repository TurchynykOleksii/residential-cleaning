<?php
/*
Template Name: move-in-move tamplate
*/
 get_header(); ?>

<main class="main">

    <section class="banner-move">
        <div class="container">
            <div class="banner-move__inner">
                <p class="banner-move__headline">Experience the Difference: </p>
                <h1 class="banner-move__title">Move In Move Out Cleaning</h1>
                <button class="banner-move__btn"><span>Call now</span> <img src="<?=get_template_directory_uri() ?>/build/img/icons/arrow-right-white.svg"
            ...
            <div class="prices__inner">
                ...
                <div class="prices__offer">
                    ...
                    <ul class="prices__list prices__commercial prices__hide">
                        <li class="prices__item">
                            <div class="prices__num"><img src="<?=get_template_directory_uri() ?>/build/img/icons/comercial-icon.svg" alt="commercial icon">
                            </div>
                            <ul class="prices__info">
                ...
                <div class="feetback__wrapper">
                    ...
                    <div class="feetback__info">
                        ...
                        <a href="#" class="bttn feetback__btn">Request service <img
                                src="<?=get_template_directory_uri() ?>/build/img/icons/arrow-right-white.svg" alt="arrow icon"></a>
                    </div>
                </div>
            </div>
        </div>
